...
<div
	class="mx-auto w-full max-w-md rounded-none border border-gray-300 bg-white p-4 shadow md:rounded-2xl md:p-8 dark:border-gray-800 dark:bg-black"
>
	...
	<form class="my-8" on:submit={handleSubmit}>
		<div class="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
